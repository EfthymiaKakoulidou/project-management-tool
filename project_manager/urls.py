...
from .views import (
    ...
    EditProfile, DeleteProfile, EditTask, DeleteTask, Tasks, Home, EditTaskAT
)
...
urlpatterns = [
    ...
    path('task/<slug:pk>/', TaskDetail.as_view(), name='task_detail'),
    ...
    path("task/<slug:pk>", EditTaskAT.as_view(), name="edit_task_at"),
]
